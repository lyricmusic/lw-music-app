...
| `room-invites` HTTPS function              | Included                               | Invite redemption writes membership and invite usage, so every POST is checked before token redemption. CORS supports the App Check header.                                                                                                                                           |
